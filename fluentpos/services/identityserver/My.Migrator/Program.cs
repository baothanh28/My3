using My.Infrastructure.HealthChecks;
...
namespace My.Migrator
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.WebHost.UseMyLogger(configuration =>
            {
            ...
            services.AddPersistence(configuration["ConnectionStrings:My"],
           ...
           .Execute(() =>
           {
               ...
               .SqlDatabase(configuration.GetConnectionString("My"))
